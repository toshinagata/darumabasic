...
#else
#define PERIPHERAL_BASE                 0x3F000000 // Peripheral Base Address (RPi2)
#endif
...
#else
#define data_sync_barrier()	asm volatile ("dsb" ::: "memory")
#define data_mem_barrier() 	asm volatile ("dmb" ::: "memory")
#define peripheral_entry()	((void) 0)	// ignored here
#define peripheral_exit()	((void) 0)
#endif
...
/*  The following definitions were taken from circle/sysconfig.h  */
