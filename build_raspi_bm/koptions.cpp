...
:	m_nWidth (0),
	m_nHeight (0),
		/* LogDebug -> LogPanic: essentially no message unless explicitly
		   designated as kernel option (2017/04/01 Toshi Nagata) */
	m_nLogLevel (LogDebug /*LogPanic*/),
	m_nUSBPowerDelay (0),
	m_CPUSpeed (CPUSpeedLow),
	m_nSoCMaxTemp (60)
{
	strcpy (m_LogDevice, "tty1");
	strcpy (m_KeyMap, "US"); /* 2017/04/16 Toshi Nagata */
